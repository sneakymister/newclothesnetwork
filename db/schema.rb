...
ActiveRecord::Schema.define(version: 20160112013218) do
  ...
  add_index "nonprofits", ["email"], name: "index_nonprofits_on_email", unique: true
  add_index "nonprofits", ["reset_password_token"], name: "index_nonprofits_on_reset_password_token", unique: true
  ...
  add_index "posts", ["retailer_id"], name: "index_posts_on_retailer_id"
